...
df1 = pd.read_csv('/Users/aharris/Desktop/Things/Data Exploration/CovidDeaths.csv', low_memory=False)
df1.to_sql('CovidDeaths', engine, if_exists='replace', index=False)

df2 = pd.read_csv('/Users/aharris/Desktop/Things/Data Exploration/CovidVacinations.csv', low_memory=False)
